	 ...
	 <div class="product-section">
		...
		<div class="product-description col-md-5">
			...
			<div class="list">
				<ul>
					...
					<li>Never flat large wheels</li>
					<li>Ultra compact fold</li>
					<li>Maximum Safety with IRP technology</li>
				</ul>
			</div>
		</div>
		...
		<div class="product-rightside col-md-4">
		 <div class="product-tranbox col-md-12">
			...
			<div class="radio">
				<label>
					<input type="radio" name="ColorRadios1" id="ColorRadios1" value="QNB09735" checked>
					<img src="/img/Carbon Grey.png">
				</label>
			</div>
			</div>
